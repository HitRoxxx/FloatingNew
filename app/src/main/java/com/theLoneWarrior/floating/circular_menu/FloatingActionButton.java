...
public class FloatingActionButton extends FrameLayout {
    ...
    public FloatingActionButton(Context context, ViewGroup.LayoutParams layoutParams, int theme,
        ...
        if (backgroundDrawable == null) {
            if (theme == THEME_LIGHT)
                backgroundDrawable = context.getResources().getDrawable(com.theLoneWarrior.floating.R.drawable.button_action_selector);
            else
                backgroundDrawable = context.getResources().getDrawable(com.theLoneWarrior.floating.R.drawable.button_action_dark_selector);
        }
    ...
    public void setPosition(int position, ViewGroup.LayoutParams layoutParams) {
        ...
        if (!systemOverlay) {
            ...
            try {
                ...
                lp.gravity = gravity;
                if (setDefaultMargin) {
                    int margin = getContext().getResources().getDimensionPixelSize(com.theLoneWarrior.floating.R.dimen.action_button_margin);
                    lp.x = margin;
                    lp.y = margin;
                }
                setLayoutParams(lp);
    ...
    public void setContentView(View contentView, LayoutParams contentParams) {
        ...
        if (contentParams == null) {
            ...
            final int margin = getResources().getDimensionPixelSize(com.theLoneWarrior.floating.R.dimen.action_button_content_margin);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            int margin = context.getResources().getDimensionPixelSize(com.theLoneWarrior.floating.R.dimen.action_button_margin);
