package com.theLoneWarrior.floating.feedback;
...
import com.theLoneWarrior.floating.feedback.components.DeviceInfo;
import com.theLoneWarrior.floating.feedback.components.SystemLog;
import com.theLoneWarrior.floating.feedback.components.Utils;
...
public class FeedbackActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        if (withInfo) {
            ...
            deviceInfo.setSpan(new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    View feedbackDialog = FeedbackActivity.this.getLayoutInflater().inflate(R.layout.feedback_dialog, null);
                    TextView title = (TextView) feedbackDialog.findViewById(R.id.titleDialog);
                    title.setText(R.string.info_fedback_legal_system_info);

                    TextView message = (TextView) feedbackDialog.findViewById(R.id.messageDialog);
                    message.setText(FeedbackActivity.this.deviceInfo);
                    message.setMovementMethod(new ScrollingMovementMethod());

                    new AlertDialog.Builder(FeedbackActivity.this)
                            .setView(feedbackDialog)
            ...
            systemLog.setSpan(new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    View feedbackDialog = FeedbackActivity.this.getLayoutInflater().inflate(R.layout.feedback_dialog, null);
                    TextView title = (TextView) feedbackDialog.findViewById(R.id.titleDialog);
                    title.setText(R.string.info_fedback_legal_log_data);

                    TextView message = (TextView) feedbackDialog.findViewById(R.id.messageDialog);
                    message.setText(FeedbackActivity.this.LOG_TO_STRING);
                    message.setMovementMethod(new ScrollingMovementMethod());
    ...
    public String getAppLabel() {
        return getResources().getString(R.string.app_contact);
    }
