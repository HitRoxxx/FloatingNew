...
public class UtilsApp {
   ...
   /* public static void setAppHidden(Context context, FloatingActionButton fabHide, Boolean isHidden) {
    ...
    public static Boolean saveIconToCache(Context context, AppInfo appInfo) {
        ...
        try {
            ApplicationInfo applicationInfo = context.getPackageManager().getApplicationInfo(appInfo.getPacName(), 0);
            File fileUri = new File(context.getCacheDir(), appInfo.getPacName());
    ...
    public static Boolean removeIconFromCache(Context context, AppInfo appInfo) {
        File file = new File(context.getCacheDir(), appInfo.getPacName());
        return file.delete();
    }
    ...
    public static Drawable getIconFromCache(Context context, AppInfo appInfo) {
        ...
        try {
            ...
            e.printStackTrace();
            res = context.getResources().getDrawable(R.drawable.default_image);
        }
